...
import nl.briansporkslede.workshopper.repository.FileUploadRepository;
...
public class PhotoService {
    ...
    public String storeDefaultPicture(MultipartFile file, String url) {

        String fileName = StringUtils.cleanPath(Objects.requireNonNull(file.getOriginalFilename()));

        Path filePath = Paths.get(fileStoragePath + FileSystems.getDefault().getSeparator() + "default.jpg");
    ...
    public Resource downLoadDefaultPicture(String fileName) {

        Path path = Paths.get(fileStorageLocation).toAbsolutePath().resolve("default.jpg");
